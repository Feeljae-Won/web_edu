...
public class Execute {
	...
	// 서비스를 실행 시키고 로그 출력하는 프로그램 메서드 작성
...
//		Authority.checkAuth(service);
		...
		// 실행 객체 정보를 출력
		// service 객체를 클래스로 바꾸자. -> servic.getClass()
		// 클래스의 이름을 패키지와 함께 가져오자 -> getName()
		System.out.println("실행 객체 : " + service.getClass().getName()); 
		
		// 넘어오는 데이터 출력
		// 배열인지 물어보자 : obj instanceof Object[]
		// 배열이면 배열 출력하는 Arrays.tosTring() 사용하고 아니면 obj 를 그냥 출력한다.
